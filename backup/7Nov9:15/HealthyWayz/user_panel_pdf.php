...
$name = "Panel";
$main_img = 'images/pdf_report/img3.png';
$qry_img = "select * from `panel_info` where id = '".$id."'";
$res_img = $conn->query($qry_img);
$row_img = $res_img->fetch_assoc();
if ( $row_img['image_link'] != ''){
    $main_img= $row_img['image_link'];
    $name = $row_img['Name'];
}
$html='
<!DOCTYPE html>
      ...
      <div style="border: 5px solid #ffffff;">
         <div id="content">
            ...
            @page { margin: 5px; }
                ...
                .page:before {
                    content: url("images/favicon.png");"Gene-Think";
                    position:absolute;
                    right:45px;
                    height:70px;
                    color:#11142f;
...
$html .='
             ...
             <div class="page">
                    <center>
                        <img src="'.$main_img.'" style="width: 780px;">
                    </center>
...
';
            ...
            $qry_phenotype = "select phenotype from `panel` where panel_info_id=$id group by `phenotype`";
			$res_phenotype = $conn->query($qry_phenotype);
			while($row_phenotype = $res_phenotype->fetch_assoc()) {
                
                $Traits=array();
                $qry_Traits = "select traits from `panel` where panel_info_id=$id && phenotype = '".$row_phenotype['phenotype']."' group by `Traits`";
        ...
        $html.='<!-- Category Starts Here -->
            <div class="page page-header">
                 <img src="images/pdf_report/corner1.png" style="width:20%">
                <div class="para-content">
                    <center>
                        <b>
                         <br/>
        ...
        $html.='<table class="table-score"  align="center">
                          <tr>';
                            if($x < count($Traits) ){ 
                        ...
                        <tr>';
                        if($x < count($Traits) ){ 
                        $html.='<td class="danger" style="width:100px;"> 
                        ...
                        $html.='<td class="light"  style="width:100px;">
                            <span class="box-indicator"></span> 
                            <span class="box-indicator"></span>
                            <span class="box-indicator"></span>
                        ...
                        $html.='<td class="warning"  style="width:100px;">
                            <span class="box-indicator"></span> 
                            <span class="box-indicator"></span>
                ...
                <div style="position: absolute;bottom: 0px;text-align: right; width: 100%;">
                    <img src="images/pdf_report/corner2.png"  style="width:25%">
                </div>
            </div>
            <!-- Page 6 end -->';
            ...
            // $html.=$qry_img.'<br/>';   
             ...
             <div class="page page-header">
                <div class="para-content">
                    <h1>'.$Traits[$x].'</h1>
                    <center>
                        <img class="traits-img" src="'.$trait_img.'" >
                    </center>
                    ...
                    <tr>
                      ...
                      <tr>
                        ...
                        <tr>
                        <td class="danger" style="width:100px;"> 
                            <span class="box-indicator"></span> 
                            <span class="box-indicator"></span>
                            <span class="box-indicator"></span>
                            <span class="box-indicator"></span>
                ...
                $qry_gene = "select gene, genotype, description, traits from `panel` where panel_info_id=$id && phenotype = '".$row_phenotype['phenotype']."' && traits = '".$Traits[$x]."'";
    			$res_gene = $conn->query($qry_gene);
    			while($row_gene = $res_gene->fetch_assoc()) {
                //$html .=$qry_gene .'<br/>';
                $html.='
                <div class="gene-table" style="page-break-inside: avoid;">
                    ...
                    <p  style="page-break-inside: avoid;" >'. $row_gene['description'] .'</p>
                </div>';
            ...
            <div class="page page-header">
                ...
                <center>
                         <h2 class="primary">Do\'s and Don\'ts</h2>
                    </center>
                    <div class="row" >
                        <div class="do col-5">
                            <h3>
...
$document->render();
$font = $document->getFontMetrics()->get_font("Times New Roman", "bold");
$canvas = $document->getCanvas();
/*
$document->getCanvas()->filled_rectangle(10, 750, 590, 35, array(0,0,255));
$document->getCanvas()->image("images/favicon.png", 560, 15, 35, 45, $resolution = "normal");*/

$footer = $canvas->open_object();
$canvas->page_text(180, 760, 'Powered By Pro Healthywayz International LLP', $font, 12, array(0, 0, 0));
$canvas->close_object();
$canvas->add_object($footer, 'all');
if(isset($_GET['download'])){
    $document->stream($name."-Gene-Think");
}else{
   $document->stream($name."-Gene-Think", array("Attachment"=>0));
}
