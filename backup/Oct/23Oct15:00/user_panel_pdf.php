...
<html>
   <head>
      <title>HealthyWayz</title>
      <script src="https://code.jquery.com/jquery-1.12.4.js"></script>
      <script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf/1.3.3/jspdf.min.js"></script>
      <script src="https://html2canvas.hertzen.com/dist/html2canvas.js"></script>
   </head>
   <body>
      <center style="padding: 10px;"><a href="#" onclick="getPDF();">Download PDF</a></center>
         ...
         <div id="content">
            <style>
               ...
               .table-user-info, .table-user-info th, .table-user-info td {
                   border-bottom: 3px solid #0065aa87;
            ...
            <div class="page">
               ...
               <div class="para-content">
                  <center>
                     <h1 class="main-title primary"><span style="font-size: 65px;">Predictive</span> <br/>DNA REPORT</h1>
                     <img src="images/pdf_report/img.png">
            ...
            <div class="page page-header">
             ...
             <div class="page page-header">
                <div class="para-content">
                    ...
                    <center>
                    <table class="table-score-info" style="width:60%;border:1px solid #ddd0;">
                      <tr>
                    ...
                    <table class="table-score-info" style="width:85%;border:1px solid #ddd0;">
                      <tr>
...
about genetic predispositions only and may not indicate current conditions or characteristics.</td>
            ...
            <!-- Page 4 end -->
             ...
             <div class="page page-header">
               ...
               <img src="images/pdf_report/img3.png" style="width: 100%;" class="page-height">
                ...
                <div class="para-content">
                    <center>
                        <b>
                         <br/>
                        <h2>Category Summary</h2>
                        <h1 class="title primary"><?php echo $row_phenotype['phenotype']; ?></h1>
                        
                       <?php for ($x = 0; $x < count($Traits); $x+=3) {
                               
                        ?> 
                        
                        <table class="table-score">
                          <tr>
                            <?php if($x < count($Traits) ){ ?>
                            <td class="danger"> 9.0 </td>
                            <?php }if($x+1 < count($Traits) ){ ?>
                            <td class="danger-light">7.0</td>
                            <?php }if($x+2 < count($Traits) ){ ?>
                            <td class="warning">5.9</td>
                            <?php } ?>
                          </tr>    
                        <tr>
                      ...
                      <tr>
                        <?php if($x < count($Traits) ){ ?>
                        <td class="danger"> <?php echo $Traits[$x]; ?> </td>
                        <?php }if($x+1 < count($Traits) ){ ?>
                        <td class="danger-light"> <?php echo $Traits[$x+1]; ?> </td>
                        <?php }if($x+2 < count($Traits) ){ ?>
                        <td class="warning"><?php echo $Traits[$x+2]; ?> </td>
                        <?php } ?>
                      </tr>
                      </table>
            ...
            <!-- Page 6 end -->
             <?php for ($x = 0; $x < count($Traits); $x+=1) { ?>
            
             <!-- Page 7 start -->
             <div class="page page-header">
                <div class="para-content">
                    <h1><?php echo $Traits[$x]; ?></h1>
                    <center>
                        <img src="images/pdf_report/safetyResponse.png" >
                    </center>
                    <h3 class="primary">What is <?php echo $Traits[$x]; ?>?</h3>
                    <p>
                        Satiety means feeling of fullness or suppression of hunger for a period of time after a meal. 
                        Certain genetic variations can influence the ability to feel satiated after consumption of a meal, which can lead to overeating for individuals with a poor satiety response. 
                        Over eating can lead to an excessive calorie intake, thereby increasing the risk of weight gain.
                ...
                <div class="gene-table">
                    <button class="gene-table-btn1">Gene Name : <?php echo $row_gene['gene']; ?></button>
                    <button class="gene-table-btn2">Your Genotype : <?php echo $row_gene['genotype']; ?></button>
                    <p><?php echo $row_gene['description']; ?></p>
                </div>
...
$(document).ready(function() {
         ...
         $(".page").css("min-height", PDF_Height);
         $(".page-header").prepend('<div class="header"><img style="width: 10%;" src="images/genetics.png" > </div>');
         $(".page").append('<div  class = "footer"> <div > <center> <span style="color:black;"><b>Powered By</b></span> <span style="color:#2d2d2d;font-size:20px;">Pro Healthywayz International LLP </span> </center></div> </div>');
         $(".page-height").css("min-height", PDF_Height);
         var HTML_Height = $("#content").height()-1;
         alert(Math.ceil(HTML_Height/PDF_Height)-1);
});
</script>
      <script type="text/javascript">
         function getPDF(){
         ...
         var imgData = canvas.toDataURL("images/", 1.0);
         var pdf = new jsPDF('p', 'pt',  [PDF_Width, PDF_Height]);
         pdf.addImage(imgData, 'JPG', top_left_margin, top_left_margin,canvas_image_width,canvas_image_height);
         for (var i = 1; i <= totalPDFPages; i++) { 
            pdf.addPage(PDF_Width, PDF_Height);
            pdf.addImage(imgData, 'JPG', top_left_margin, -(PDF_Height*i)+(top_left_margin*4),canvas_image_width,canvas_image_height);
            pdf.addHTML('<div  class = "footer"> <div > <center> <span style="color:black;"><b>Powered By</b></span> <span style="color:#2d2d2d;font-size:20px;">Pro Healthywayz International LLP </span> </center></div> </div>');
         }
